...
//         description: "Dive deep into modern JavaScript features, best practices, and advanced techniques for building robust web applications.",
//         courseThumbnail: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=400&q=80",
...
//         description: "Learn React from scratch and build interactive UIs efficiently.",
//         courseThumbnail: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=400&q=80",
...
//                 <div dangerouslySetInnerHTML={{ __html: truncateText(course?.description, 15) }} />

//             </div>
//             <div className="px-2 pt-4 pb-2">
//                 <p className="text-sm text-gray-600">Level: {course.courseLevel} ⭐ </p>
...
//       className="w-full max-w-sm h-auto rounded-lg shadow-lg bg-white p-5 flex flex-col justify-between items-center cursor-pointer hover:shadow-xl transition duration-300"
//     >
//       <div className="text-center">
//         <h3 className="text-xl font-bold text-blue-900 mb-2">Explore All Courses</h3>
//         <p className="text-gray-700 text-sm">
//           Discover more amazing courses tailored just for you.
//         </p>
//         <button className=" mt-12 cursor-pointer bg-[#192A88] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#15206f] transition duration-200">
//         Browse All
//       </button>
//       </div>
