      ...
      <div className='w-full min-h-screen mt-[-2%] overflow-x-hidden bg-gray-50'>
        ...
        <div className='flex items-center gap-4 ml-[5%] mt-6'>
          <img 
            ...
            className='w-16 h-16 md:w-20 md:h-20 rounded-lg object-cover shadow-md border border-gray-300'
          />
          <h1 className='font-bold text-lg md:text-2xl text-gray-900'>{course?.course?.courseTitle}</h1>
        </div>
        ...
        <div className='flex flex-col lg:flex-row w-[90%] gap-8 mx-auto mt-8 mb-[7%]'>
          ...
          <div className='flex flex-col w-full lg:w-[65%] bg-white shadow-xl shadow-gray-300 p-6 rounded-xl'>
            {currentLecture && (
              <>
                ...
                <h1 className='font-semibold mt-4 text-lg md:text-xl text-gray-800 px-2'>
          ...
          <div className='flex flex-col w-full lg:w-[30%] bg-white shadow-lg shadow-gray-200 rounded-2xl p-6 text-sm md:text-lg'>
            <h1 className='font-bold text-xl md:text-2xl mb-6 text-gray-900'>Course Content</h1>
              ...
              {lectures?.lectures.map((lecture) => (
                <li
                  ...
                  className={`flex items-center gap-4 cursor-pointer border-2 p-3 rounded-xl transition-colors duration-200
                    ...
                    `}
                >
                  <CgPlayButtonO className='text-lg md:text-xl' />
