...
//     <>
//       <Navbar />
//       <div className='w-full min-h-screen mt-[-2%] overflow-x-hidden'>

//         <div className='flex gap-3 items-center ml-[5%]'>
//           <img src={course?.course?.courseThumbnail} width="80" height="80" />
//           <h1 className='font-bold text-xl'>{course?.course?.courseTitle}</h1>

//         </div>


//         <div className='flex w-[90%] gap-10 mx-auto mt-[3%]'>

//           <div className='flex flex-col w-[65%] shadow-xl shadow-gray-300 p-5 rounded-xl '>
//             {currentLecture && (
//               <div className='w-full rounded-xl overflow-hidden'>

//                 <video src={currentLecture?.videoUrl} controls className='w-full h-auto rounded-xl p-5' />
//                 <h1 className='font-bold mt-[2%] p-5 text-lg'>
...
//           <div className='flex flex-col w-[30%] shadow-xl shadow-gray-200 rounded-2xl p-6 text-lg'>
//             <h1 className='font-bold text-xl mb-4'>Course Content</h1>
//             <ul className='space-y-2'>
//               {lectures?.lectures.map((lecture) => (
//                 <li
//                   key={lecture._id}
//                   onClick={() => setCurrentLecture(lecture)}
//                   className={`flex items-center gap-4 cursor-pointer border-2 p-3 rounded-xl ${currentLecture?._id === lecture._id
